...
public class UtilServicio {
    ...
    public void validarUsuario(String nombreUsuario, String nombre, String
            apellido, Date fechaDeNacimiento, Long DNI, String email) throws MiException {
    ...
    public void validarPassword(Usuario usuario, String actualPassword, String password, String password2) throws MiException{
        
        boolean verificar = verificarContrasenaActual(actualPassword, usuario.getPassword());
